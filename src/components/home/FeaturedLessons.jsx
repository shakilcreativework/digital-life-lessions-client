...
const FeaturedLessons = () => {
  ...
  const lessonsData = [
  {
    ...
    // VISUAL MATCH: A thoughtful character looking out at a vast landscape sunrise, identical to your 1st card style
    ImageSrc: "https://images.unsplash.com/photo-1475924156734-496f6cac6ec1?auto=format&fit=crop&w=600&q=80",
    likes: "1.2K",
    comments: "128",
  ...
  },
  {
    ...
    // VISUAL MATCH: A high-contrast artistic profile portrait surrounded by expressive, vibrant color brushstrokes
  ...
  },
  {
    ...
    // VISUAL MATCH: A clean, colorful structural conceptual rendering with steps and geometric shapes showing personal growth direction
  ...
  },
  {
    ...
    // VISUAL MATCH: Two characters engaging in a deep, meaningful lifestyle setting with rich stylized background art
    ImageSrc: "https://images.unsplash.com/photo-1511632765486-a01980e01a18?auto=format&fit=crop&w=600&q=80",
    likes: "1.8K",
    comments: "146",
